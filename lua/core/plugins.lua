local plugins = {
  ...
  ["wbthomason/packer.nvim"] = {
    setup = function()
      nvim.lazy_load_commands("packer.nvim", {
        "PackerSnapshot",
  ...
  ["Darazaki/indent-o-matic"] = {
    opt = true,
    setup = function() table.insert(nvim.file_plugins, "indent-o-matic") end,
    config = function() require "configs.indent-o-matic" end,
  },
  -- Notification Enhancer
  ["rcarriga/nvim-notify"] = {
    module = "notify",
    setup = function() nvim.load_plugin_with_func("nvim-notify", vim, "notify") end,
    config = function() require "configs.notify" end,
  },
  -- Neovim UI Enhancer
  ["stevearc/dressing.nvim"] = {
    opt = true,
    setup = function() nvim.load_plugin_with_func("dressing.nvim", vim.ui, { "input", "select" }) end,
  ...
  ["famiu/bufdelete.nvim"] = {
    module = "bufdelete",
    setup = function() nvim.lazy_load_commands("bufdelete.nvim", { "Bdelete", "Bwipeout" }) end,
  },
  ...
  ["nvim-neo-tree/neo-tree.nvim"] = {
    ...
    setup = function()
      nvim.lazy_load_commands("neo-tree.nvim", "Neotree")
  ...
  ["nvim-treesitter/nvim-treesitter"] = {
    ...
    setup = function()
      table.insert(nvim.file_plugins, "nvim-treesitter")
      nvim.lazy_load_commands("nvim-treesitter", {
        "TSBufDisable",
        "TSBufEnable",
        "TSBufToggle",
        "TSDisable",
  ...
  ["saadparwaiz1/cmp_luasnip"] = {
    after = "nvim-cmp",
    config = function() nvim.add_user_cmp_source "luasnip" end,
  },
  -- Buffer completion source
  ["hrsh7th/cmp-buffer"] = { after = "nvim-cmp", config = function() nvim.add_user_cmp_source "buffer" end },
  -- Path completion source
  ["hrsh7th/cmp-path"] = { after = "nvim-cmp", config = function() nvim.add_user_cmp_source "path" end },
  -- LSP completion source
  ["hrsh7th/cmp-nvim-lsp"] = { after = "nvim-cmp", config = function() nvim.add_user_cmp_source "nvim_lsp" end },
  -- Built-in LSP
  ["neovim/nvim-lspconfig"] = {
    module = "lspconfig",
    setup = function() table.insert(nvim.file_plugins, "nvim-lspconfig") end,
    config = function() require "configs.lspconfig" end,
  },
  -- Formatting and linting
  ["jose-elias-alvarez/null-ls.nvim"] = {
    module = "null-ls",
    setup = function() table.insert(nvim.file_plugins, "null-ls.nvim") end,
  ...
  ["nvim-telescope/telescope.nvim"] = {
    module = "telescope",
    setup = function() nvim.lazy_load_commands("telescope.nvim", "Telescope") end,
  ...
  ["lewis6991/gitsigns.nvim"] = {
    ...
    ft = "gitcommit",
    setup = function() table.insert(nvim.git_plugins, "gitsigns.nvim") end,
    config = function() require "configs.gitsigns" end,
  },
  -- Start screen
  ["goolord/alpha-nvim"] = {
    module = "alpha",
    setup = function() nvim.lazy_load_commands("alpha-nvim", "Alpha") end,
  ...
  ["akinsho/toggleterm.nvim"] = {
    module = "toggleterm",
    setup = function() nvim.lazy_load_commands("toggleterm.nvim", { "ToggleTerm", "TermExec" }) end,
  ...
  ["lukas-reineke/indent-blankline.nvim"] = {
    opt = true,
    setup = function() table.insert(nvim.file_plugins, "indent-blankline.nvim") end,
    config = function() require "configs.ident_blankline" end,
  },
  -- Keymaps popup
  ...
  ["Shatur/neovim-session-manager"] = {
    ...
    event = "BufWritePost",
    setup = function() nvim.lazy_load_commands("neovim-session-manager", "SessionManager") end,
...
if status_ok then
  packer.startup {
    ...
    config = {
      compile_path = nvim.default_compile_path,
      display = {
