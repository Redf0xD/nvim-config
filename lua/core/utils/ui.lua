...
local function ui_notify(str)
  if vim.g.ui_notifications_enabled then nvim.notify(str) end
end

--- Toggle notifications for UI toggles
function nvim.ui.toggle_ui_notifications()
...
--- Toggle autopairs
function nvim.ui.toggle_autopairs()
...
--- Toggle diagnostics
function nvim.ui.toggle_diagnostics()
  local status = "on"
  ...
  vim.diagnostic.config(nvim.lsp.diagnostics[bool2str(vim.g.diagnostics_enabled)])
  ui_notify(string.format("diagnostics %s", status))
end

--- Toggle background="dark"|"light"
function nvim.ui.toggle_background()
  vim.go.background = vim.go.background == "light" and "dark" or "light"
  ui_notify(string.format("background=%s", vim.go.background))
end

--- Toggle cmp entrirely
function nvim.ui.toggle_cmp()
...
function nvim.ui.toggle_signcolumn()
...
function nvim.ui.toggle_url_match()
